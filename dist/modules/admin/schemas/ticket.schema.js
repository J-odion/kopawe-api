...
exports.SupportTicketSchema = exports.SupportTicket = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const swagger_1 = require("@nestjs/swagger");
let SupportTicket = class SupportTicket extends mongoose_2.Document {
    memberId;
    subject;
    description;
    status;
...
], SupportTicket.prototype, "memberId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, mongoose_1.Prop)({ enum: ['OPEN', 'IN_PROGRESS', 'RESOLVED', 'CLOSED'], default: 'OPEN' }),
    __metadata("design:type", String)
